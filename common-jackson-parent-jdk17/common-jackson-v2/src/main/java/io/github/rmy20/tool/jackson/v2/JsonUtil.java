package io.github.rmy20.tool.jackson.v2;
...
public class JsonUtil {
    ...
    private static JsonTool defaultTool = JSON_TOOL;
    ...
    public static String writeValueAsString(Object obj, ThrowingConsumer<Throwable, ? extends Throwable> errorHandler) {
        return defaultTool().toJson(obj, errorHandler);
    }
    ...
    private static JsonTool defaultTool() {
        return defaultTool;
    }

    public static void defaultTool(JsonTool defaultTool) {
        JsonUtil.defaultTool = defaultTool;
    }
}
