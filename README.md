...
| 模块             | 介绍                    |
|----------------|-----------------------|
| common-core    | 日期、随机数、字符串等util       |
| common-http    | http工具类               |
| common-crypto  | 加解密工具类                |
| common-jackson | 基于Jackson的json、xml工具类 |
| common-log     | 日志门面                  |
...
1. 定义请求示例，并配置每次请求设置的参数

    - UrlConnection

        ```java
        private static final BaseRequestTool tool = UrlConnectionRequestTool.create().readTimeout(30);
        ```

        [完整示例](common-http/common-http-core/src/test/java/io/github/rmy20/tool/urlconnection/UrlConnectionRequestTest.java)
    ...
    - okhttp
        ...
        [完整示例](common-http/common-okhttp/src/test/java/io/github/rmy20/tool/okhttp/OkHttpRequestTest.java)
    ...
    - httpclient5
        ...
        [完整示例](common-http/common-httpclient5/src/test/java/io/github/rmy20/tool/httpclient5/HttpClient5RequestTest.java)
...
2. 请求示例
    ...
    - get请求
        ...
        ```
        BaseExecutor<String> executor = tool.get("http://127.0.0.1:6021/").paths("/test/get")
        ...
        Assert.isTrue(executor.isOk(), "get请求失败");
        System.out.println("get结果：" + executor.get());
...
- [完整示例](common-http/common-http-core/src/test/java/io/github/rmy20/tool/urlconnection/UrlConnectionTest.java)
...
- 以`form`请求为例
    ...
    ```
    OkHttpExecutor<String> executor = OkHttpTool.form(uri).paths("/test/form")
            ...
            .stringExecutor().execute();
    Assert.isTrue(executor.isOk(), "okhttp form 请求失败");
    System.out.println("okhttp form结果：" + executor.get());
    executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    ```

- [完整示例](common-http/common-okhttp/src/test/java/io/github/rmy20/tool/okhttp/OkHttpTest.java)
...
- 以`异步上传`为例
    ...
    HttpClient5MultipartRequest multipartRequest = HttpClient5Tool.multipart(uri).path("upload").path("multi")
...
- [完整示例](common-http/common-httpclient5/src/test/java/io/github/rmy20/tool/httpclient5/HttpClient5Test.java)
