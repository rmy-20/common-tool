...
public class OkHttpRequest extends OkHttpBaseRequest<OkHttpRequest> implements BaseHttpRequest<OkHttpRequest> {
    ...
    @Override
    public OkHttpRequest body(byte[] body, io.github.rmy20.tool.http.core.MediaType mediaType, Charset charset) {
    ...
    @Override
    public OkHttpRequest body(File body, io.github.rmy20.tool.http.core.MediaType mediaType, Charset charset) {
        return body(body, Objects.nonNull(mediaType) ? MediaType.parse(mediaType.getMediaType()) : (MediaType) null);
    }
