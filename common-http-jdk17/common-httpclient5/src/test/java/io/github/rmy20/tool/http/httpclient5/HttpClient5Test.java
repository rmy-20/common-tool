...
import io.github.rmy20.tool.http.httpclient5.executor.HttpClient5Executor;
...
class HttpClient5Test {
    ...
    void get() {
        ...
        HttpClient5Executor<String> executor = HttpClient5Tool.get(uri).paths("/test/get")
    ...
    void form() {
        ...
        HttpClient5Executor<String> executor = HttpClient5Tool.form(uri).paths("/test/form")
    ...
    void upload() throws Exception {
        ...
        HttpClient5Executor<String> executor = multipartRequest.stringExecutor().execute();
