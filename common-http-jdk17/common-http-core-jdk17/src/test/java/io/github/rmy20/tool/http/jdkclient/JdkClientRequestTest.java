...
class JdkClientRequestTest {
    ...
    void get() throws Exception {
        ...
        Assert.isTrue(executor.isOk(), "Jdk HttpClient get请求失败");
        System.out.println("Jdk HttpClient get结果：" + executor.get());
    ...
    void getAsync() throws Exception {
        ...
        Assert.isTrue(executor.isOk(), "Jdk HttpClient get 异步请求失败");
        System.out.println("Jdk HttpClient get 异步结果：" + executor.get());
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
    ...
    void post() {
        ...
        Assert.isTrue(executor.isOk(), "Jdk HttpClient post请求失败");
        System.out.println("Jdk HttpClient post结果：" + executor.get());
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
    ...
    void postAsync() throws Exception {
        ...
        Assert.isTrue(executor.isOk(), "Jdk HttpClient post 异步请求失败");
        System.out.println("Jdk HttpClient post 异步结果：" + executor.get());
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
    ...
    void download() {
        ...
        BaseExecutor<Long> executor = tool.get(uri).paths("download")
                ...
                .downloadExecutor(new File("/opt/Jdk HttpClient/" + "SM2公私钥对.txt")).execute();
        Assert.isTrue(executor.isOk() && executor.get() >= 0, "Jdk HttpClient 下载文件失败");
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
    ...
    void downloadAsync() throws Exception {
        ...
        CompletableFuture<? extends BaseExecutor<Long>> future = tool.get(uri).paths("download")
                .applicationOctetStream()
                .downloadExecutor(new File("/opt/Jdk HttpClient/async/" + "SM2公私钥对.txt")).executeAsync();
        for (int i = 0; i < 20; i++) {
            System.out.println(i);
            TimeUnit.MILLISECONDS.sleep(200L);
        }
        BaseExecutor<Long> executor = future.join();
        Assert.isTrue(executor.isOk() && executor.get() >= 0, "Jdk HttpClient 异步下载文件失败");
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
    ...
    void form() {
        ...
        BaseExecutor<String> executor = tool.form(uri).paths("/test/form")
                ...
                .stringExecutor().execute();
        Assert.isTrue(executor.isOk(), "Jdk HttpClient form 请求失败");
        System.out.println("Jdk HttpClient form结果：" + executor.get());
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
    ...
    void formAsync() throws Exception {
        ...
        BaseExecutor<String> executor = future.join();
        Assert.isTrue(executor.isOk(), "Jdk HttpClient form 异步请求失败");
        System.out.println("Jdk HttpClient form 异步结果：" + executor.get());
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
    ...
    void upload() throws Exception {
        ...
        Assert.isTrue(executor.isOk(), "Jdk HttpClient上传失败");
        System.out.println("Jdk HttpClient上传结果：" + executor.get());
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
    ...
    void uploadAsync() throws Exception {
        ...
        BaseExecutor<String> executor = future.join();
        Assert.isTrue(executor.isOk(), "Jdk HttpClient 异步上传失败");
        System.out.println("Jdk HttpClient 异步上传结果：" + executor.get());
        executor.getHeaders().forEach((name, value) -> System.out.println("header --> " + name + "：" + value));
    }
}
